    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between flex-wrap align-items-center">
                ...
                <button type="button" class="button btn btn-primary" onclick="window.location='{{ route('dashboard.package.create') }}'">Add Package</button>
            </div>
            <div class="card-body">
                    ...
                    <table id="example2" class="border-top-0  table table-bordered text-nowrap border-bottom">
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>{{$item->days}}</td>
                                <td>
                                <a class="button btn btn-secondary square" href="{{ route('dashboard.package.edit',$item->id) }}">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="{{ route('dashboard.package.delete', $item->id) }}" method="POST" >
                                                        @csrf
