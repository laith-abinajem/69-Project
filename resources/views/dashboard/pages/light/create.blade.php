                        ...
                        <section>
                            <div class="row row-sm">
                                ...
                                <div class="col-12 mg-t-20 mg-md-t-0 mb-2">
                                    ...
                                    <textarea class="form-control" id="branddescription" name="light_description" placeholder="Textarea" rows="3" required>{{ old('light_description') }}</textarea>
                                </div>
                            </div>
                        </section>
                                                ...
                                                <div class="col-12 mb-2">
                                                    ...
                                                    <div class="row prices_container">
                                                        <div class="col-12 col-md-3">
                                                            <input class="form-control front-w-s" name="price[{{ $class_item }}][{{ $subclass_item }}][head_price]" value="{{ old('price.' . $class_item . '.' . $subclass_item . '.head_price') }}" placeholder="Head Price" required="" type="text">
                                                        </div>
                                                        <div class="col-12 col-md-3">
                                                            <input class="form-control front-two" name="price[{{ $class_item }}][{{ $subclass_item }}][fog_price]" value="{{ old('price.' . $class_item . '.' . $subclass_item . '.fog_price') }}" placeholder="Fog Price" required="" type="text">
                                                        </div>
                                                        <div class="col-12 col-md-3">
                                                            <input class="form-control back-half" name="price[{{ $class_item }}][{{ $subclass_item }}][tail_price]" value="{{ old('price.' . $class_item . '.' . $subclass_item . '.tail_price') }}" placeholder="Tail Price" required="" type="text">
                                                        </div>
                                                        <div class="col-12 col-md-3">
