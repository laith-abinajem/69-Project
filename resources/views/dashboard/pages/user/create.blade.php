                        ...
                        <section>
                            <div class="row row-sm">
                                <div class="col-6 mb-2">
                                    ...
                                    <input type="file" name="company_logo" value="{{ old('company_logo') }}" id="companylogo" class="dropify2" data-height="200" required />
                                ...
                                <div class="col-6 mb-2">
                                    ...
                                    <input type="file" name="decal_logo" value="{{ old('decal_logo') }}" id="decallogo" class="dropify2" data-height="200" required />
                                    <small class="form-text text-muted">
                                ...
                                <div class="col-6 mb-2">
                                    ...
                                    <input type="file" name="detailing_decal" value="{{ old('detailing_decal') }}" id="detailingdecal" class="dropify2" data-height="200" required />
                                    <small class="form-text text-muted">
                                        Recommended dimensions: 1000x500 pixels, transparent background
                                    </small>
                                </div>
                                <div class="col-12 mb-2">
                                    ...
                                    <input type="file" name="video" value="{{ old('video') }}"  id="browseFile" class="dropify2" data-height="200"   accept="video/*" />
                                    <div id="message"></div>
                                </div>
