                    ...
                    <div class="row row-sm">
                            ...
                            <div class="col-6">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input value="{{ $data->api_key }}" class="form-control" name="api_key" placeholder="Enter api key"  type="text">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group mg-b-0">
                                    <label class="form-label">Business Id (CRM) </label>
                                    <input value="{{ $data->business_id }}" class="form-control" name="business_id" placeholder="Enter business id"  type="text">
                                </div>
                            </div>
                            <div class="col-6">
