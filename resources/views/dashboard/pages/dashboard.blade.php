                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-md-8 col-xl-8">
                            <div class="card overflow-hidden review-project">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <h4 class="card-title mg-b-10">subscriptions expierd within the week </h4>
                                        <i class="mdi mdi-dots-horizontal text-gray"></i>
                                    </div>
                                    <p class="tx-12 text-muted mb-3"></p>
                                    <div class="table-responsive mb-0" style="overflow:auto; height:360px;">
                                        <table class="table table-hover table-bordered mb-0 text-md-nowrap text-lg-nowrap text-xl-nowrap table-striped ">
                                            <thead>
                                                <tr>
                                                    <th>Id</th>
                                            ...
                                            <tbody>
                                            @foreach ($subscriber_expiry_week as $item)
                                                <tr>
                                                    <td>{{$item->id}}</td>
