...
<div class="modal fade" id="managePlanModal2" tabindex="-1" aria-labelledby="managePlanModalLabel2" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered  modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <form id="subscription-form2" action="{{ route('dashboard.subscription.store') }}" method="post">
                    @csrf
                    <div class="row row-sm">
                            <div class="col-6">
                                <div class="form-group">
...
<script>
    async function initializeSquarePayments() {
        const payments = Square.payments('production-sq0idp-8mKT7to57PX7XoTmEAiTPA', 'production'); // or 'production'
