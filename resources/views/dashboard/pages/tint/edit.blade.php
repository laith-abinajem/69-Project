                        ...
                        <section>
                            <div class="row row-sm">
                                <div class="col-12 mb-2">
                                    ...
                                    <input type="file" name="tint_image" id="brandimage" class="dropify2 largeDropify" data-default-file="{{ $photos }}" data-height="200" />
                                </div>
                                ...
                                <div class="col-md-5 col-lg-6 mb-2">
                                    ...
                                    <select name="tint_brand_level" id="tint_brand_level" class="form-control paintProtectionFil">
                                        ...
                                        <option value="PREMIUM_PLUS" {{ $tintBrand->tint_brand_level == 'PREMIUM_PLUS' ? 'selected' : '' }}>PREMIUM PLUS </option>
                                                        ...
                                                        <div class="row prices_container">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <div class="main-toggle">
                                                                    <span></span>
                                                                    <input type="hidden" class="toggle-value" name="hide[{{ $class_item }}][{{ $subclass_item }}]" value="{{ $existingDetails[$class_item][$subclass_item]['hide'] ?? 'false' }}" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
