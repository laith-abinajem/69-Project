                        ...
                        <section>
                            <div class="row row-sm">
                                <div class="col-12 mb-2">
                                    ...
                                    <input type="file" name="tint_image" id="brandimage" class="dropify" data-height="200" required />
                                </div>
                                <div class="col-md-5 col-lg-4 mb-2">
                                    <label class="form-control-label">Brand Name: <span class="tx-danger">*</span></label> <input class="form-control" id="brandname" name="tint" placeholder="Tint Brand" required="" type="text">
                                </div>
                                <div class="col-12 mg-t-20 mg-md-t-0 mb-2">
                                    <label class="form-control-label">Brand Description: <span class="tx-danger">*</span></label>
                                    <textarea class="form-control" id="branddescription" name="tint_description" placeholder="Textarea" rows="3" required></textarea>
                                </div>
                            </div>
                        </section>
                        <h3>Tint Details</h3>
